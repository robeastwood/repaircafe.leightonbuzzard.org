        ...
        <section class="pb-20 bg-gray-300 -mt-24">
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap">
                    <div
                        class="pt-6 pt-6 w-full md:w-4/12 px-4 text-center"
                    >
                        <div
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-gray-600">
                                    A repair cafe is all about sharing the skills needed to maintain and repair household goods - it's amazing how much you can fix with just a few tips, tricks and confidence.
                                    On the other hand, if you've a fix-it mentality, come along to see if you can help out others in your community and share your knowledge!
                                </p>
                            </div>
                        </div>
                    </div>
