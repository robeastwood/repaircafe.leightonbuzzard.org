    ...
    <div class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 75vh">
        ...
        <div class="container relative mx-auto">
            <div class="text-center py-4 lg:px-4">
                <div class="rounded p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
                    role="alert">
                    <span class="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">News</span>
                    <span class="mr-2 text-left flex-auto">There'll be a clock & watch repair/advice provided by Dean
                        Quy from Stephen Alan's Jewellers at the Repair Cafe on the 30th September
                    </span>
                </div>
                <div class="rounded mt-2 p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
                    role="alert">
                    <span class="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">News</span>
                    <span class="mr-2 text-left flex-auto">The Buzz Cycles group will be holding bike repair and second
                        hand bike sale at the market: 10am - 4pm Saturday 30th September
