...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        Category::create([
            ...
            'description' => 'Toasters, Kettles, Blenders, Mixers, Coffee machines, and other such items',
            'powered' => 'mains',
        ]);
        Category::create([
        ...
        Category::create([
            ...
            'description' => 'Amplifiers, Speakers, VCRs, CD/DVD/BluRay Players, Media Players, Set top boxes etc',
            'powered' => 'mains',
        ]);
        Category::create([
            'name' => 'Desktop PCs',
        ...
        Category::create([
            ...
            'description' => "Anything electronic that doesn't fit in the other categories",
            'powered' => 'batteries',
        ]);
        Category::create([
            'name' => 'Other',
            'description' => "Anything else that doesn't fit in the other categories",
            'powered' => 'no',
        ]);
    }
}
